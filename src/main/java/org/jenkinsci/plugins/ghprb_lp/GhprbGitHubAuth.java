...
public class GhprbGitHubAuth extends AbstractDescribableImpl<GhprbGitHubAuth> {
    ...
    // Local proxy for this server API url only
    private final String serverAPIProxy;
    ...
    public GhprbGitHubAuth(
        ...
        this.serverAPIProxy = fixEmptyAndTrim(serverAPIProxy);
    ...
    @Exported
    public String getServerAPIProxy() {
    ...
    private static GitHubBuilder getBuilder(Item context, String serverAPIUrl, String serverAPIProxy, String credentialsId) {
        GitHubBuilder builder = new GitHubBuilder()
                .withEndpoint(serverAPIUrl)
                .withConnector(new HttpConnectorWithCustomProxy(serverAPIProxy));
    ...
    private void buildConnection(Item context) {
        GitHubBuilder builder = getBuilder(context, serverAPIUrl, serverAPIProxy, credentialsId);
        if (builder == null) {
    ...
    public static final class DescriptorImpl extends Descriptor<GhprbGitHubAuth> {
        ...
        public FormValidation doCreateApiToken(
                ...
                @QueryParameter("serverAPIProxy") final String serverAPIProxy,
        ...
        public FormValidation doCheckRepoAccess(
            ...
            try {
                GitHubBuilder builder = getBuilder(null, serverAPIUrl, serverAPIProxy, credentialsId);
                if (builder == null) {
